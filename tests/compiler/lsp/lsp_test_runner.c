...
void start_lsp_server() {
    if (pipe(pipe_in) < 0 || pipe(pipe_out) < 0) fail("Pipe creation failed");
    child_pid = fork();
    if (child_pid < 0) fail("Fork failed");
    ...
    for (int i = 0; i < 500; i++) {
        ...
        if (json) {
            ...
            if (id_item) {
                 ...
                 int got_id = -1;
                 if (cJSON_IsNumber(id_item)) got_id = id_item->valueint;
                 else if (cJSON_IsString(id_item)) got_id = atoi(id_item->valuestring);

                 if (got_id == id) {
                    cJSON_Delete(json);
                    return msg; // Found it
                } else {
                    printf("Mismatch ID: got %d (type=%d) expected %d\n", got_id, id_item->type, id);
                }
            } else {
...
void test_initialize() {
    ...
    if (!resp) fail("No response for initialize");
    
    // Validate basics
    if (!strstr(resp, "capabilities")) fail("Init response missing capabilities");
...
void test_hover() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_lsp.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"fn main() { return 0; }\"}}}");
    ...
    // Hover over 'main'
    send_request("{\"jsonrpc\": \"2.0\", \"id\": 2, \"method\": \"textDocument/hover\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_lsp.zc\"}, \"position\": {\"line\": 0, \"character\": 5}}}");
...
void test_completion() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_compl.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"fn test_func(arg_val: int) { var local_idx = 10; \\n    \\n }\"}}}");
    usleep(100000);

    // Request completion inside the function body
    send_request("{\"jsonrpc\": \"2.0\", \"id\": 10, \"method\": \"textDocument/completion\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_compl.zc\"}, \"position\": {\"line\": 1, \"character\": 4}}}");
...
void test_struct_completion() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_struct.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"struct Point { x: int; y: int; }\\nfn main() {\\n    var my_point: Point;\\n    my_point.\\n}\"}}}");
    usleep(100000);

    // Request completion at 'my_point.' (line 3, character 13)
    // 4 spaces + 8 chars + 1 dot = 13
    send_request("{\"jsonrpc\": \"2.0\", \"id\": 20, \"method\": \"textDocument/completion\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_struct.zc\"}, \"position\": {\"line\": 3, \"character\": 13}}}");
...
void test_diagnostics() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_error.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"fn main() { var x: int = ; }\"}}}");
...
void test_semantic_tokens() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_semantic.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"fn hello() { var x = 10; }\"}}}");
    usleep(100000);

    send_request("{\"jsonrpc\": \"2.0\", \"id\": 50, \"method\": \"textDocument/semanticTokens/full\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_semantic.zc\"}}}");
...
void test_definition() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_def.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"fn target() {}\\nfn main() {\\n    target();\\n}\"}}}");
    usleep(100000);

    // Request definition at line 2, character 6 (start of "target")
    send_request("{\"jsonrpc\": \"2.0\", \"id\": 60, \"method\": \"textDocument/definition\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_def.zc\"}, \"position\": {\"line\": 2, \"character\": 6}}}");
...
void test_references() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"id\": 70, \"method\": \"textDocument/references\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_def.zc\"}, \"position\": {\"line\": 0, \"character\": 5}, \"context\": {\"includeDeclaration\": true}}}");
...
void test_rename() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"id\": 80, \"method\": \"textDocument/rename\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_def.zc\"}, \"position\": {\"line\": 0, \"character\": 5}, \"newName\": \"renamed_target\"}}");
...
void test_outline() {
    ...
    send_request("{\"jsonrpc\": \"2.0\", \"method\": \"textDocument/didOpen\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_outline.zc\", \"languageId\": \"zenc\", \"version\": 1, \"text\": \"struct Point { x: i32; y: i32; }\\nfn main() {}\"}}}");
    usleep(100000);

    send_request("{\"jsonrpc\": \"2.0\", \"id\": 90, \"method\": \"textDocument/documentSymbol\", \"params\": {\"textDocument\": {\"uri\": \"file:///tmp/test_outline.zc\"}}}");
